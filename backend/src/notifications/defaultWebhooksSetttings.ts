...
defaultWebhooksSetttings[EventTypes.ADMIN_BOOKING_UPDATED] = [WebhookTypes.discord, WebhookTypes.email, WebhookTypes.slack];
defaultWebhooksSetttings[EventTypes.ADMIN_BOOKING_CREATED] = [WebhookTypes.discord, WebhookTypes.email, WebhookTypes.slack];
