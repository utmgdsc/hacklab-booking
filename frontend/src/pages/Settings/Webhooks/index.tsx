...
import {
    ...
    FormControl,
    Grid, ListItemText, MenuItem, Select,
    Table,
    TableBody,
    TableCell,
    TableContainer,
...
import {
    SelectWebhookType
} from '../../../components/Webhooks/SelectWebhookType';
...
const webhookEvents: Record<string, {
    name: string,
    description: string,
    admin?: boolean
}> = {
                                ...
                                <Table sx={{ minWidth: 650 }}
                                    ...
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell
                                                align='right'>Destinations</TableCell>
                                        </TableRow>
                                    </TableHead>
                                    <TableBody>
                                        {Object.keys(webhookEvents).filter(event=>isAdmin || !(webhookEvents[event].admin || event.startsWith("ADMIN"))).map(event => {
                                                return (
                                                    <TableRow
                                                        key={event}
