...
export const EditBooking = ({ isOpen, reqID, setOpenEditRequest }: EditBookingProps) => {
    ...
    return (
        <Dialog
            ...
            onClose={handleClose}
            TransitionComponent={
                Transition as React.JSXElementConstructor<TransitionProps & { children: React.ReactElement<any, any> }>
            }
        >
            <AppBar sx={{ position: 'relative' }}>
                <Toolbar>
                    ...
                    <IconButton edge="end" color="inherit" onClick={handleClose} aria-label="cancel">
                        <CloseIcon />
                    </IconButton>
                </Toolbar>
            </AppBar>
