 ...
 * @property {UserRoles[]} props.role the list role(s) that the user must have one of to render the children
 * @property {React.ReactNode} props.children the children to protect with the role
